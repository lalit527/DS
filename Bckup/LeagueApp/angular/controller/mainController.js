'use strict'
gotApp.controller('gotMainController', ['$scope','$http', 'getAllUrlService', 'getAllDataService', 'getDetailFactory', '$location', "NgTableParams", "$interval", "$timeout", function($scope, $http, getAllUrlService, getAllDataService, getDetailFactory, $location, NgTableParams, $interval, $timeout){
    var main = this;
    main.allUrl = {};
    main.books = 1;
    main.bookUrl;
